...
export const api = {
    ...
    editarProducto: (prod: string, data: { descripcion: string; imagen: string; estado: string; categoria: string[]; costo?: number; precio_venta?: number }) => request(`/inventario/${prod}`, { method: "PATCH", body: JSON.stringify(data) }),
    // Categorías
