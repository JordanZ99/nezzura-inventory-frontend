"use client"
// ==============================================================================
// src/components/CatalogoView.tsx
// Catálogo público de productos — vista para clientes (cliente).
//
// Recibe los datos iniciales desde el servidor (page.tsx) para que los
// crawlers (WhatsApp, Facebook, etc.) vean el contenido correcto en los
// Open Graph tags. Una vez hidratado, funciona como SPA normal.
//
// Esta vista NO es parte del gestor. Es una vista pública, elegante y
...
export default function CatalogoView({ initialData, error: serverError }: CatalogoViewProps) {
    const [datos, setDatos] = useState<RespuestaCatalogo | null>(initialData || null)
